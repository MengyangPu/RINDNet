...
from modeling.CASENet import CaseNet
...
class Trainer(object):
    ...
    def test(self, epoch):
        ...
        self.reflectance_output_dir2 = os.path.join(self.saver.experiment_dir, 'fuse_outs', str(epoch + 1),
                                                   'reflectance/mat')
        if not os.path.exists(self.reflectance_output_dir2):
            os.makedirs(self.reflectance_output_dir2)
        self.illumination_output_dir2 = os.path.join(self.saver.experiment_dir, 'fuse_outs', str(epoch + 1),
                                                    'illumination/mat')
