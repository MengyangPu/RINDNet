...
from my_options.DexiNed_options import DexiNed_Options
from modeling.DexiNed_edge import *
...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        for i, (image, target) in enumerate(tbar):
            ...
            loss = sum([self.criterion(preds, target, l_w) for preds, l_w in zip(preds_list,l_weight)])
