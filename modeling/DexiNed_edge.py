...
#        block_5_pre_dense_256 = self.pre_dense_6(block_5_add) # if error uncomment
        ...
        out_1 = self.slice(self.up_block_1(block_1), slice_shape)   #[1, 1, 320, 320]
        out_2 = self.slice(self.up_block_2(block_2), slice_shape)   #[1, 1, 320, 320]
        out_3 = self.slice(self.up_block_3(block_3), slice_shape)   #[1, 1, 320, 320]
        out_4 = self.slice(self.up_block_4(block_4), slice_shape)   #[1, 1, 320, 320]
        out_5 = self.slice(self.up_block_5(block_5), slice_shape)   #[1, 1, 320, 320]
        out_6 = self.slice(self.up_block_6(block_6), slice_shape)   #[1, 1, 320, 320]
