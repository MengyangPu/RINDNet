...
class Decoder(nn.Module):
    def __init__(self, backbone, BatchNorm):
        ...
        self.conv10_depth = Conv_Stage(16, [8, 8, 8, 8, 4], output_map=True)
        self.conv10_normal = Conv_Stage(16, [8, 8, 8, 8, 4], output_map=True)
        self.conv10_reflectance = Conv_Stage(16, [8, 8, 8, 8, 4], output_map=True)
        self.conv10_illumination = Conv_Stage(16, [8, 8, 8, 8, 4], output_map=True)
        self._init_weight()
    ...
    def forward(self, x, low_level_feat,crop_h,crop_w):
        ...
        out_depth = self.conv10_depth(x_crop)  # [1, 4, 320, 320]
        out_normal = self.conv10_normal(x_crop)  # [1, 4, 320, 320]
        out_reflectance = self.conv10_reflectance(x_crop)  # [1, 4, 320, 320]
        out_illumination = self.conv10_illumination(x_crop)  # [1, 4, 320, 320]
        ...
        return [out_depth,out_normal,out_reflectance,out_illumination]
