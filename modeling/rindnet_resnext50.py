...
class MyNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = self._make_layer2(Bottleneck2, 64, layers[0])
        self.layer2 = self._make_layer2(Bottleneck2, 128, layers[1], stride=2,
                                        dilate=replace_stride_with_dilation[0])
        self.layer3 = self._make_layer2(Bottleneck2, 256, layers[2], stride=2,
                                        dilate=replace_stride_with_dilation[1])
        self.layer4 = self._make_layer2(Bottleneck2, 512, layers[3], stride=2,
                                        dilate=replace_stride_with_dilation[2])

        #resnext = models.resnext101_32x8d(True)
        #self.conv1 = resnext.conv1
        #self.bn1 = resnext.bn1
        #self.relu = resnext.relu
        #self.maxpool = resnext.maxpool
        #self.layer1 = resnext.layer1
        #self.layer2_2 = resnext.layer2
        ...
        # self.unet3a
        self.unet3a = self._make_resblock(Bottleneck2, 512, 128)
        # self.unet3b
        self.unet3b = self._make_resblock(Bottleneck2, 512, 8, expansion=2)
        # self.unet1a
        ...
        # self.unet3a
        self.reflectance_unet3a_2 = self._make_resblock(Bottleneck2, 256, 128)
        # self.unet3b
        self.reflectance_unet3b_2 = self._make_resblock(Bottleneck2, 512, 8, expansion=2)
        # self.unet1a
        ...
        # self.unet3a
        self.illumination_unet3a_2 = self._make_resblock(Bottleneck2, 256, 128)
        # self.unet3b
        self.illumination_unet3b_2 = self._make_resblock(Bottleneck2, 512, 8, expansion=2)
        # self.unet1a
    ...
    def _make_resnextblock(self, block, planes, stride=1, expansion=4):
        norm_layer = self._norm_layer
        ...
        return block(self.inplanes, planes, stride, downsample, groups=self.groups,
                     base_width=self.base_width, dilation=self.dilation,
                     norm_layer=norm_layer, expansion=expansion)

    def load_resnet(self):
        print('Loading pre-trained resnext50_32x4d')
