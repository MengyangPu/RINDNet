...
class DexiNed_Options:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description="PyTorch Dexined Training")
        ...
        self.parser.add_argument('--checkname', type=str, default='DexiNed',
