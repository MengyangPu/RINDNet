...
class myNet_Options:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description="PyTorch RINDNet Training")
        ...
        self.parser.add_argument('--test-batch-size', type=int, default=1,
                                 metavar='N', help='input batch resnet for testing (default: auto)')
        ...
        self.parser.add_argument('--lr-step', type=int, default=None,
        ...
        self.parser.add_argument('--checkname', type=str, default='rindnet',
