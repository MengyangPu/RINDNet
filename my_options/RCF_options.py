...
class RCF_Options:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description="PyTorch RCF Training")
        ...
        self.parser.add_argument('--weight-decay', type=float, default=2e-4,
                                 metavar='M', help='w-decay (default: 5e-4)')
        self.parser.add_argument('--stepsize', default=3, type=int,
                                 metavar='SS', help='learning rate step size')
        self.parser.add_argument('--gamma', '--gm', default=0.1, type=float,
                                 help='learning rate decay parameter: Gamma')
        self.parser.add_argument('--itersize', default=10, type=int,
        ...
        self.parser.add_argument('--checkname', type=str, default='rcf',
        ...
        self.parser.add_argument('--pretrain-model', default='../rindnet/model/vgg16convs.mat',
